    ...
    <div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-xl transition-all hover:border-emerald-500/50 hover:bg-slate-50">
        <div class="relative flex items-start justify-between">
            <div class="min-w-0">
                ...
                <p class="mt-1 sm:mt-2 text-xs sm:text-lg lg:text-xl font-bold text-slate-900 metric-value leading-snug break-words"><?= rupiah(is_numeric($setor) ? $setor : 0); ?></p>
            </div>
...
<!-- Visualisasi & Aktivitas (satu kolom: grafik di atas, aktivitas di bawah) -->
