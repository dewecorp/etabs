    ...
    <div class="relative w-full max-w-6xl rounded-2xl bg-white p-6 shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <form id="formEditMultiple" method="post" action="?page=MyApp/edit_siswa_multiple" class="flex flex-col flex-1 overflow-hidden">
            ...
            <div class="mt-5 flex justify-end gap-3 pt-4 border-t border-slate-100  shrink-0">
                ...
                <button type="submit" class="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-indigo-700 hover:shadow-lg hover:shadow-emerald-500/30 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all">
    ...
    <div class="relative w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl  transition-all">
        ...
        <form action="" method="post">
            ...
            <div class="mt-8 flex justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                <button type="submit" name="Simpan" class="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-indigo-700 hover:shadow-lg hover:shadow-emerald-500/30 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all">
                    <i class="fa-solid fa-floppy-disk"></i>
                    <span>Simpan</span>
                </button>
            </div>
